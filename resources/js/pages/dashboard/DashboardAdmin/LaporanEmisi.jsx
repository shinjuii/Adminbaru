      ...
      <div className="flex-1 ml-[90px] lg:ml-[290px] transition-all duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="group bg-white rounded-2xl shadow-lg hover:shadow-xl p-6 border border-gray-100 
            ...
            <p className="text-xs mt-2" style={{ color: '#3E5F44' }}>+12% dari bulan lalu</p>
          </div>
          ...
          <div className="group bg-white rounded-2xl shadow-lg hover:shadow-xl p-6 border border-gray-100 
            ...
            <p style={{ color: '#5C6D5D' }} className="text-sm font-medium mb-1">Total Emisi</p>
            <p className="text-3xl font-bold" style={{ color: '#1E1E1E' }}>{totalEmisi} Ton CO₂</p>
                  ...
                  <div className="col-span-3">
                    <div className="flex items-center gap-2">
                      <div className="p-2 rounded-lg" style={{ backgroundColor: '#e8f0e9' }}>
                        <FiDollarSign size={16} style={{ color: '#3E5F44' }} />
                      </div>
